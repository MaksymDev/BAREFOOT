!function($){"use strict";function USHeader(settings){this.settings=settings||{};this.state='default';this.$container=$us.$canvas.find('.l-header');this.scrolledOccupiedHeight=0;if(this.$container.length==0){return}
