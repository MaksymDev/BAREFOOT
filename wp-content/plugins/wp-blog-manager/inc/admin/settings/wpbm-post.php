...
<div class="wpbm-post-selection-wrap">
        ...
        <div class="wpbm-post-field-wrap">
            ...
            if ( is_array( $post_types ) ) {
                ...
                <select  name="wpbm_option[post_type]" class="wpbm-post-type">
                    ...
                    foreach ( $post_types as $key => $value ) {
                        ?>
                        <option value="<?php echo $key; ?>" <?php if ( isset( $wpbm_option[ 'post_type' ] ) && $wpbm_option[ 'post_type' ] == $key ) echo 'selected=="selected"'; ?>><?php echo $value; ?></option>
                    <?php }
                    ?>
                </select>
            <?php } ?>
    ...
    <div class="wpbm-query-wrapper">
        <ul class="wpbm-query-tab">
            <li data-menu="taxonomy-settings" class="wpbm-query-tigger wpbm-query-active">
                <?php _e( 'Taxonomies/Categories', WPBM_TD ) ?>
            </li>
            <li data-menu="custom-settings" class="wpbm-query-tigger">
                <?php _e( 'Custom Field', WPBM_TD ) ?>
            </li>
            <li data-menu="search-settings" class="wpbm-query-tigger">
                <?php _e( 'Search Keyword', WPBM_TD ) ?>
            </li>
            <li data-menu="popular-settings" class="wpbm-query-tigger">
                <?php _e( 'Popular Post', WPBM_TD ) ?>
            </li>
        </ul>
    </div>
    ...
    <div class ="wpbm-query-setting-wrap" data-menu-ref="custom-settings">
        <?php include(WPBM_PATH . 'inc/admin/filter/wpbm-custom.php'); ?>
    </div>
    <div class ="wpbm-query-setting-wrap" data-menu-ref="search-settings">
        <?php include(WPBM_PATH . 'inc/admin/filter/wpbm-search.php'); ?>
    </div>
    <div class ="wpbm-query-setting-wrap" data-menu-ref="popular-settings">
        <?php include(WPBM_PATH . 'inc/admin/filter/wpbm-popular.php'); ?>
    </div>
